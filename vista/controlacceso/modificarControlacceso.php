...
$id = $_GET['id'];
$sql = $conexion->query("select * from control_acceso where ID_Control=$id")
?>
<!DOCTYPE html>
<html lang="en">
                ...
                while ($datos = $sql->fetch_object()) { ?>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <input type="date" class="form-control" name="fechaacceso" id="fechaacceso" value="<?= $datos->Fecha ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="mb-3 col-6">
                    ...
                    <div class="row mb-3">
                        <div class="mb-3 col-6 m-auto">
                            ...
                            <textarea class="form-control" name="observaciones" id="observaciones" placeholder="Observaciones..."> <?= $datos->Observacion ?></textarea>
                        </div>
                    </div>
